...
def profile2df(
    ...
    ::
        ...
        import pstats
        from onnxrt_backend_dev.monitoring.profiling import profile2df
...
def profile(
    ...
    **kwargs,
) -> Union[Tuple[Stats, Any], Tuple[Stats, Any, Any]]:
    """
...
def profile2graph(
    ...
    clean_text: Optional[Callable] = None,
    verbose: bool = False,
) -> Tuple[Any, Dict[Any, ProfileNode]]:
    """
